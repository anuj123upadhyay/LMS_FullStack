...
import { getStatsData } from "../../Redux/statsSlice";
...
const AdminDashboard = () =>{
    ...
    return (
        <Layout>
          ...
          Admin Dashboard
            ...
            <div className="grid grid-cols-2 gap-5 m-auto mx-10">
                {/* displaying the uses chart and data  */}
                    ...
                    <div className="grid grid-cols-2 gap-5 ">
                        ...
                        <div className="flex items-center justify-between py-5 px-5 gap-5 rounded-md shadow-md">
                            <div className="flex flex-col items-center">
                                <p className="font-semibold">Registered Users
                       ...
                       <div className="flex items-center justify-between py-5 px-5 gap-5 rounded-md shadow-md">
                        <div className="flex flex-col items-center">
                            <p className="font-semibold">Subscribed Users
        ...
        <div lassName="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
...
<tbody>
            {myCourses?.map((element,index)=>{
                return(
                    ...
                    <td className="max-w-28 overflow-hidden text-ellipsis whitespace-wrap">
                        <textarea
                        readOnly
                         className="w-80 h-auto bg-transparent resize-none overflow-y-auto text-wrap " value={element?.description}
                          >
