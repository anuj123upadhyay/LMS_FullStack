...
const initialState = {
    ...
    data:localStorage.getItem('data') != undefined ? JSON.parse(localStorage.getItem('{ "name": undefined}')) : {},
...
export const forgotPassword = createAsyncThunk("auth/forgetPassword", async (email)=>{
    try {
        ...
        //getting response resolved ghere
        res = await res;
        return res.data;
    } catch (error) {
        toast.error(error?.response?.data?.message);
...
const authSlice = createSlice({
    ...
    extraReducers:(builder)=>{
        ...
        .addCase(login.fulfilled,(state,action)=>{
            ...
            localStorage.setItem("role", action?.paylos?.user?.role)
