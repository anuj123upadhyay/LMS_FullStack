      ...
      <div className="drawer absolute z-50 left-0 w-fit">
        ...
        <div className="drawer-side w-0">
          ...
          <ul className="menu p-4 w-48 sm:w-80 bg-base-100 text-base-content relative">
            ...
            {!isLoggedIn && (
              <li className="absolute bottom-6 w-[90%]">
                <div className="w-full flex items-center justify-center">
                  <button className="btn-primary px-4 py-1 font-semibold rounded-md w-full text-white">
            ...
            {isLoggedIn && (
              <li className=" w-[90%]">
                <div className="w-full flex items-center justify-center relative bottom-2">
                  <button className="btn btn-primary px-8 py-1  font-semibold rounded-md w-90% text-white" >
                    <Link to={"/user/profile"}>Profile</Link>
                  </button>
                  <button className="btn  btn-secondary px-8 py-1 font-semibold rounded-md w-90% ">
